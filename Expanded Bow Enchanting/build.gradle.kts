...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(875909, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Expanded Bow Enchanting"
...
modrinth {
    ...
    projectId.set("expanded-bow-enchanting")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Expanded Bow Enchanting")
    dependencies {
